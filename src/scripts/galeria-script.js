document.addEventListener('DOMContentLoaded', () => {
    ...
    // A) NOMBRE SECUENCIAL: Si tus fotos se llaman 1.webp, 2.webp... solo pon el número en 'count'.
    ...
    const galleryCollections = [
        {
            ...
            id: "modelo",
            folder: "Fotos/Modelo/",
            count: 13, // Usa esto si tus fotos son 1.webp, 2.webp...
            images: [] // O añade nombres aquí: ["foto1.webp", "vacaciones.webp"]
        },
        {
    ...
    function loadCategory(categoryId) {
        ...
        if (selectedCollection.count > 0) {
            for (let i = 1; i <= selectedCollection.count; i++) {
                photoUrls.push(`${selectedCollection.folder}${i}.webp`);
            }
        }
        ...
        photoUrls.forEach(url => {
            ...
            // Si la foto es 'Fotos/Modelo/1.webp', la miniatura es 'Fotos/Modelo/1_thumb.webp'
            const thumbUrl = url.replace(/(\.jpg|\.jpeg|\.webp)$/i, '_thumb$1');
